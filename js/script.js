...
var createScene = async function () {
    ...
    stick1.position = new BABYLON.Vector3(-2, 0.5, 0);
    stick2.position = new BABYLON.Vector3(2, 0.5, 0);
        ...
        controller.onMotionControllerInitObservable.add((motionController) => {
            motionController.onModelLoadedObservable.add(mc => {
                ...
                const pickStick = (stickAggregate) => {
                    ...
                    const pickInfo = scene.pickWithRay(pickRay, (mesh) => mesh === stickAggregate.body.getObject());
                    if (pickInfo.hit) {
