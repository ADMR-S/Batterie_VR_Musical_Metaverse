            ...
            controller.onMotionControllerInitObservable.add((motionController) => {
                ...
                if (xrInput) {
                    xrInput.onAxisValueChangedObservable.add((axisValues) => {
                        ...
                        xr.baseExperience.camera.position.z -= axisValues.y * speed; // Correct the z-axis movement
                    });
                }
            });
        }
    ...
    xr.input.onControllerAddedObservable.add((controller) => {
        controller.onMotionControllerInitObservable.add((motionController) => {
            motionController.onModelLoadedObservable.add(mc => {
                ...
                console.log(controller)
                const controllerPhysics = xr.baseExperience.featuresManager.enableFeature(BABYLON.WebXRControllerPhysics.Name, 'latest')
